...
exports.AttachmentGenerator = () => {
    return [
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(14000), "Standard Blaster")
            )
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(42000), "Hardened Blaster")
            )
            .BattlePreTurnFn((battle) => {
                const rnd = rb(8, 12);
                battle.Enemy.standardDamage(rnd);
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(145000), "Rapidfire Blaster")
            )
            .BattlePreTurnFn((battle) => {
                const rnd = rb(8, 18);
                battle.Enemy.standardDamage(rnd);
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(295000), "Mini Scattergun")
            )
            .BattlePreTurnFn((battle) => {
                const base = 10;
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(275000), "Thermic Focuser")
            )
            .BattlePreTurnFn((battle) => {
                const base = 4;
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(200000), "Precision Railgun")
            )
            .BattlePreTurnFn((battle) => {
                const base = rb(8, 12);
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(520000), "Plasma Cannon")
            )
            .BattlePreTurnFn((battle) => {
                const base = rb(15, 25);
                battle.Enemy.standardDamage(base);
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(385000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(295000), "Flak Cannon")
            )
            .BattlePreTurnFn((battle) => {
                const base = 0;
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(360000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(275000), "Sunfire Beam")
            )
            .BattlePreTurnFn((battle) => {
                const base = 2;
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(360000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(275000), "Quasar Cannon")
            )
            .BattlePreTurnFn((battle) => {
                const effective = 30;
                battle.Enemy.standardDamage(effective);
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(385000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(295000), "Heavy Flak Launcher")
            )
            .BattlePreTurnFn((battle) => {
                const base = 0;
                const bonus = ~~(battle.Enemy.Hp / 50);
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(11000), "Iron Plating")
            )
            .EquipFn((friendly) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(38000), "Steel Plating")
            )
            .EquipFn((friendly) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(175000), "Titanium Plating")
            )
            .EquipFn((friendly) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.MODERATE_BUILD(530000),
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(920000), "Ty'Linian Exoplate")
            )
            .EquipFn((friendly) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(3100000), "Antimatter Plating")
            )
            .EquipFn((friendly) => {
...
const ReserveGenerator = () => {
    ...
    return [
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(5000), "Basic Weapon Reserves")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(15000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(5000), "Basic Engine Reserves")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(15000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(5000), "Basic Computer Reserves")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(75000), "Weapons Battery")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(150000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(75000), "Engine Battery")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(150000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(75000), "Computer Battery")
            )
            .EquipFn((ship) => {
                ship.incrementStatistics({ energy: [0, 0, levelTwoSingle] });
                return { message: `New Computer Energy: ${ship.ShipStatistics.totalEnergy[2]}`, success: true };
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(150000), "Full Spectrum Battery")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(390000), "Weapons Energy Cell")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(500000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(390000), "Engine Fuel Deposit")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(500000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(390000), "Computer Battery")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.MODERATE_BUILD(595000),
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(715000), "Shield Cells")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.MODERATE_BUILD(1290000),
                    "Weapons Energy Matrix"
                )
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(1450000), "Spectral Matrix")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(1750000), "Shield Matrix")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.MODERATE_BUILD(2800000),
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableSellable(3500000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(2800000), "Modular Fuel Cells")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(3100000),
                    "Modular Spectral Array"
                )
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(3700000),
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(8000000),
...
const CargoGenerator = () => {
    ...
    return [
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(45000), "Small Cargo Hold")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(300000), "Medium Cargo Hold")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(560000), "Large Cargo Hold")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.MODERATE_BUILD(975000),
                    "Compressing Cargo Hold"
                )
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(3200000),
...
const ThrusterGenerator = () => {
    ...
    return [
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(1060000), "Basic Thruster")
            )
            .EquipFn((ship) => {
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(3860000),
                    "Full Phase Thrusters"
                )
            )
            .EquipFn((ship) => {
...
const ShieldGenerator = () => {
    return [
        new Attachment_1.AttachmentBuilder({
            ...
            strength: 5,
            techLevel: 2,
            type: Attachment_1.AttachmentType.SHIELD,
        })
            .EnableSellable(35000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(21000), "Blink Shield")
            )
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(390000),
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(425000), "Holo-Shield")
            )
            .BattlePreTurnFn((battle) => {
                const rnd = rb(4, 8);
                battle.Friendly.shieldIncrease(rnd);
        ...
        new Attachment_1.AttachmentBuilder({
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(505000), "Energising Shield")
            )
            .BattlePreTurnFn((battle) => {
                const rnd = rb(2, 5);
                battle.Friendly.shieldIncrease(rnd);
