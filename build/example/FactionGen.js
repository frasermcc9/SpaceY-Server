...
exports.FactionGenerator = () => {
    return [
        ...
        new Faction_1.FactionBuilder({
            name: "Erisna",
            description: "The newest formed galactic alliance, made from many systems which have only had space travel for a small amount of time. Despite this, they are quickly beginning to invest heavily in their technological developments.",
            techLevel: 3,
        })
        ...
        new Faction_1.FactionBuilder({
            name: "Ty'Lin",
            description: "An alliance built from various non-humanoid species, with particularly exotic looking ships. The individual systems are rather tribalistic. Often the only common belief shared is the desire for withholding threats from the several surrounding alliances.",
            techLevel: 4,
        })
        ...
        new Faction_1.FactionBuilder({
            name: "Terra",
            description: "The alliance that humans developed, alongside neighboring systems. Once seen as a fairly non-influential group, the development of a capital ship has given Terrans a much higher standing on the galactic stage.",
            techLevel: 5,
        })
        ...
        new Faction_1.FactionBuilder({
            name: "Volog",
            description: "Volians have few systems to their name, but they more than make up for it due to the shear number of ships they produce. This natural ship-building talent has led to the extreme wealth that Volian systems have.",
            techLevel: 6,
        })
        ...
        new Faction_1.FactionBuilder({
            name: "Quarg",
            description: "The Quargic alliance is built on imperialism and destruction. Their ships are often heavily armed, or in the cases of their larger ships, the whole vessel is build around their super-weapon - the Prismatic Death Ray.",
            techLevel: 7,
        })
        ...
        new Faction_1.FactionBuilder({
            name: "Alaira",
            description: "Galaxies that belong to the Alairan alliance were all fully dominated by the technocratic Alairan race. Technology and advancement is seen as the " +
        ...
        new Faction_1.FactionBuilder({
            name: "Anarchy",
            description: "Many systems, especially those around the outer edge, have very low amounts of civilised populations, with many falling to anarchy. These systems are often avoided due to the high amount of danger they possess.",
            techLevel: 4,
        })
        ...
        new Faction_1.FactionBuilder({
            name: "Unknown",
            description: "Almost nothing is known about the nature of these systems. No successful exploratory voyage has ever occurred, with all vessels warping never coming back. The only information known is from a ship that was promptly destroyed " +
