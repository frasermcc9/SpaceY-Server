...
exports.ShipGenerator = () => {
    return [
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(61000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(40000), "Recovered Shuttle")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(118000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(75000), "Kalen Taxi")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(177000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(125000), "Terran Scout")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(183000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(128000), "Erisnian Transport")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(282000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(200000), "Quargic Jet")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(303000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(210000), "Lumissian Needle")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(349000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(280000), "Kalen Transport")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            description:
                "A ship thats widely used and manufactured all over the galaxy, particularly because of its strong engine and high cargo capacity.",
            techLevel: 3,
        })
            ...
            .EnableSell(421000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(315000), "Standard Transport")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(469000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(365000), "Volian Gunship")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            description:
                "An agile and menacing ship, used extensively throughout Ty'Linic regions. Often seen as a direct upgrade over the Volian Gunship with little compromise.",
            techLevel: 5,
        })
            ...
            .EnableSell(512000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(365000), "Ty'linic Warship")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(655000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(520000), "Alairan Patroller")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            description:
                "A ship that is used frequently by Terran civilians. This one has had some modifications to make it a bit more able in battle.",
            techLevel: 4,
        })
            ...
            .EnableSell(753000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(640000), "Terran Homeship")
            )
            .SetMisc({
        ...
        new Ship_1.ShipBuilder({
            name: "Volian Warship",
            description:
                "A ship that is used freqently by Terran civilians. This one has had some modifications to make it a bit more able in battle.",
            techLevel: 4,
        })
            ...
            .EnableSell(905000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.SIMPLE_BUILD(640000), "Volian Warship")
            )
            .SetMisc({
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(2121000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(1821000), "Quargic Cruiser")
            )
            .SetMisc({
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(3307000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.MODERATE_BUILD(2607000), "Ty'Linic Crawler")
            )
            .SetMisc({
        ...
        new Ship_1.ShipBuilder({
            ...
            .EnableSell(5134000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(280000), "Alairan Enforcer")
            )
            .SetMisc({
        ...
        new Ship_1.ShipBuilder({
            name: "The Executor",
            description:
                "The Terran capital ship, although less impressive than some others, does possess some unique technology. One example is the integrated warp gate, allowing for the summoning of an army at a moments notice.",
            techLevel: 11,
        })
            ...
            .EnableSell(10863000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(9600000), "The Executor")
            )
        ...
        new Ship_1.ShipBuilder({
            name: "The Revenant",
            description:
                "The Revenant is colloquially known as the 'Ghostship'. A glance at it would reveal why. It appears to be made of completely non-solid matter and absorb any projectiles that pass through it.",
            techLevel: 11,
        })
            ...
            .EnableSell(15551000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(13551000), "The Revenant")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            description:
                "An incredibly mysterious ship, whose creator and pilot is unknown. From various sightings, it seems the commander pilots the ship from the outside, controlled fully by the mind.",
            techLevel: 11,
        })
            ...
            .EnableSell(12129000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(10829000), "Mind of the Galaxy")
            )
        ...
        new Ship_1.ShipBuilder({
            name: "The Supernova",
            description:
                "The capital ship of the Lumissian alliance. The supernova often flies around the Vela system, the most central of the galaxy, as a mobile parliament.",
            techLevel: 11,
        })
            ...
            .EnableSell(11532000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(10100000), "The Supernova")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            description:
                "The Celestial Destroyer minds its own way through the galaxy, undisturbed. The entire ship is built to be a weapon. Its destructive power is unparalleled.",
            techLevel: 11,
        })
            ...
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(
                    Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(9100000),
        ...
        new Ship_1.ShipBuilder({
            name: "The Icarus",
            description:
                "A planet sized ship that has gained sentience since it was build by the Volian alliance. It now often does what it decides to do, which can often lead to widespread destruction.",
            techLevel: 11,
        })
            ...
            .EnableSell(14472000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(11000000), "The Icarus")
            )
        ...
        new Ship_1.ShipBuilder({
            ...
            description:
                "The Event Horizon represents the pride of the Alairan alliance. The ship stays at the forefront of any battle, often laying waste to whatever is in its path.",
            techLevel: 11,
        })
            ...
            .EnableSell(13085000)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(10785000), "The Event Horizon")
            )
