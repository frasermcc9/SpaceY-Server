...
class RestManager {
    constructor() {
        ...
        this.app.get("/user/:id/hasbp/:item", user_1.user_has_blueprint);
        ...
        this.app.get("/registry/attachments", registry_1.reg_attachments);
        this.app.get("/registry/factions", registry_1.reg_factions);
        this.app.get("/registry/materials", registry_1.reg_materials);
        this.app.get("/registry/ships", registry_1.reg_ships);
        this.app.get("/item/:item", item_1.item_get);
        this.app.get("/item/:item/blueprint", item_1.item_blueprint_get);
