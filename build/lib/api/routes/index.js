...
const location_asteroid_user_1 = require("./location/asteroid/user/location.asteroid.user");
...
class RestManager {
    constructor() {
        ...
        this.app.get("/location/:location/:asteroid/:userid", location_asteroid_user_1.location_asteroid_user_get);
