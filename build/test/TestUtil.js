...
function GENERATED_SHIPS() {
    return [
        new Ship_1.ShipBuilder({ name: "Shuttle", description: "A small but agile ship", techLevel: 4 })
            .EnableSell(1500)
            .EnableBuildable(
                new Blueprint_1.BlueprintBuilder().AutoBuild({
                    value: 1000,
                    rarity: true,
                    minRarity: 0,
                    maxRarity: 10,
...
function generateIntegrationSet() {
    ...
    const S5 = new Ship_1.ShipBuilder({
        ...
        .EnableSell(5134000)
        .EnableBuildable(
            new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(280000), "Asarin Enforcer")
        )
    ...
    const S6 = new Ship_1.ShipBuilder({
        ...
        .EnableSell(9800000)
        .EnableBuildable(
            new Blueprint_1.BlueprintBuilder().DefinedBuild(Blueprint_1.BlueprintBuilder.ADVANCED_BUILD(9000000), "The Celestial Destroyer")
        )
