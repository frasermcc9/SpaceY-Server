...
export const ShipGenerator = () => {
	return [
		...
		new ShipBuilder({
			...
			.EnableSell(118000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.SIMPLE_BUILD(75000), "Kalen Taxi"))
		...
		new ShipBuilder({
			...
			.EnableSell(177000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.SIMPLE_BUILD(125000), "Terran Scout"))
		...
		new ShipBuilder({
			...
			.SetWeapons({ primaryCap: 1, shieldCap: 1, heavyCap: 2, minerCap: 1, generalCap: 1 })
			.EnableSell(183000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.SIMPLE_BUILD(128000), "Erisnian Transport"))
		...
		new ShipBuilder({
			...
			.EnableSell(282000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.SIMPLE_BUILD(200000), "Quargic Jet"))
		...
		new ShipBuilder({
			...
			.EnableSell(303000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.SIMPLE_BUILD(210000), "Lumissian Needle"))
		...
		new ShipBuilder({
			...
			.SetWeapons({ primaryCap: 1, shieldCap: 1, heavyCap: 3, minerCap: 1, generalCap: 1 })
			.EnableSell(421000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.SIMPLE_BUILD(315000), "Standard Transport"))
		...
		new ShipBuilder({
			...
			.EnableSell(469000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.SIMPLE_BUILD(365000), "Volian Gunship"))
		...
		new ShipBuilder({
			...
			.SetWeapons({ primaryCap: 2, shieldCap: 1, heavyCap: 4, minerCap: 0, generalCap: 2 })
			.EnableSell(512000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.SIMPLE_BUILD(365000), "Ty'linic Warship"))
		...
		new ShipBuilder({
			...
			.EnableSell(655000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.MODERATE_BUILD(520000), "Alairan Patroller"))
		...
		new ShipBuilder({
			...
			.EnableSell(753000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.SIMPLE_BUILD(640000), "Terran Homeship"))
			.SetMisc({
		...
		new ShipBuilder({
			...
			.EnableSell(905000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.SIMPLE_BUILD(640000), "Volian Warship"))
			.SetMisc({
		...
		new ShipBuilder({
			...
			.EnableSell(5134000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.ADVANCED_BUILD(280000), "Alairan Enforcer"))
			.SetMisc({
		...
		new ShipBuilder({
			...
			.EnableSell(10863000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.ADVANCED_BUILD(9600000), "The Executor"))
		...
		new ShipBuilder({
			...
			.EnableSell(15551000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.ADVANCED_BUILD(13551000), "The Revenant"))
		...
		new ShipBuilder({
			...
			.EnableSell(12129000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.ADVANCED_BUILD(10829000), "Mind of the Galaxy"))
		...
		new ShipBuilder({
			...
			.EnableSell(11532000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.ADVANCED_BUILD(10100000), "The Supernova"))
		...
		new ShipBuilder({
			...
			.EnableSell(10460000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.ADVANCED_BUILD(9100000), "The Celestial Destroyer"))
		...
		new ShipBuilder({
			...
			.EnableSell(14472000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.ADVANCED_BUILD(11000000), "The Icarus"))
		...
		new ShipBuilder({
			...
			.EnableSell(13085000)
			.EnableBuildable(new BlueprintBuilder().DefinedBuild(BlueprintBuilder.ADVANCED_BUILD(10785000), "The Event Horizon"))
